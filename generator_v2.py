...
MARKET_DISTRIBUTIONS: dict = {
    ("chrome-120",  "windows"): 0.52,
    ("chrome-120",  "macos"):   0.10,
    ("chrome-120",  "linux"):   0.04,
    ("safari-17",   "macos"):   0.20,
    ("firefox-115", "windows"): 0.08,
    ("firefox-115", "macos"):   0.02,
    ("firefox-115", "linux"):   0.04,
}
